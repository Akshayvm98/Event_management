...
class Add_Events(tk.Frame):
	...
	def __init__(self,parent,controller):
		...
		self.name_text=tk.Text(self,height=2,width=30)
		self.price_text=tk.Text(self,height=2,width=30)
		...
		self.submit_button=tk.Button(self,text="submit",command=add_events)
...
class Add_Participants(tk.Frame):
	...
	def __init__(self,parent,controller):
		...
		self.participant_name_text=tk.Text(0,height=1,width=50)
		self.college_name_text=tk.Text(0,height=1,width=50)
		...
		self.submit_button=tk.Button(self,text="submit",command=self.add_participants)
		self.back_button=tk.Button(self,text="Back",command=lambda:controller.show_frame(StartPage))
